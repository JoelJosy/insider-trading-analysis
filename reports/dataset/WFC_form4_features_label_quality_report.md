...
## Coverage
- Forward return coverage: 1188 rows (100.0%)
- Benchmark return coverage: 1188 rows (100.0%)

## Label Distribution
- Opportunistic: 13 (1.09%)
- Routine: 0 (0.0%)
- Uncertain: 1175 (98.91%)

## Signal Counts
- Price signal rows: 305
- Earnings signal rows: 240
